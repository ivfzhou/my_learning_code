...
1. 172.16.0.0/12 172.16.0.0 - 172.31.255.255
...
1. 1024-65535：为用户端口。
1. 1024-5000：临时端口，一般的应用程序使用1024到4999来进行通讯。
1. 5001-65535：服务器（非特权）端口，用来给用户自定义端口。
...
1. 删除HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\MyComputer\NameSpace\{0DB7E03F-FC29-4DC6-9020-FF41B59E513A}
