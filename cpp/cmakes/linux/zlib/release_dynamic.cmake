...
set(ZLIB_DYNAMIC_LIBRARY_NAME libz.so.1.3.2)
...
# 添加外部构建项目。
if (NOT (ZLIB_DYNAMIC_LIBRARY AND ZLIB_INCLUDE_DIRECTORY))
    ...
    set(ZLIB_DYNAMIC_LIBRARY ${ZLIB_LIBRARY_DIRECTORY}/${ZLIB_DYNAMIC_LIBRARY_NAME})
...
list(APPEND LIBRARIES ${ZLIB_DYNAMIC_LIBRARY})
list(APPEND DYNAMIC_LIBRARIES ${ZLIB_DYNAMIC_LIBRARY})

unset(ZLIB_HEADER_NAME)
unset(ZLIB_DYNAMIC_LIBRARY_NAME)
