...
if(CPP_HTTPLIB_INCLUDE_DIRECTORY)
    ...
    ExternalProject_Add(
        ...
        CONFIGURE_COMMAND cd ${CPP_HTTPLIB_DIRECTORY}/src && rm -rf cpp-httplib-build && mkdir -p cpp-httplib-build
        ...
        INSTALL_COMMAND cd ${CPP_HTTPLIB_DIRECTORY}/src/cpp-httplib-build && ${CMAKE_COMMAND} --build . --target install
    )
