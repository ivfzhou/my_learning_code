...
if(CPP_HTTPLIB_INCLUDE_DIR)
    ...
    ExternalProject_Add(
        ...
        CONFIGURE_COMMAND cd ${CPP_HTTPLIB_DEPENDENCIES_PREFIX}/src && rm -rf cpp-httplib-build && mkdir -p cpp-httplib-build
        BUILD_COMMAND cd ${CPP_HTTPLIB_DEPENDENCIES_PREFIX}/src/cpp-httplib-build && ${CMAKE_COMMAND} -DCMAKE_INSTALL_PREFIX=${CPP_HTTPLIB_DEPENDENCIES_PREFIX} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DBUILD_SHARED_LIBS=OFF ../cpp-httplib
        INSTALL_COMMAND cd ${CPP_HTTPLIB_DEPENDENCIES_PREFIX}/src/cpp-httplib-build && ${CMAKE_COMMAND} --build . --target install
    )
