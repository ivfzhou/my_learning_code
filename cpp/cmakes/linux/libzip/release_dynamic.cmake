# 设置版本号、头文件名、代码库名称等。
set(LIBZIP_NAME libzip-release-dynamic)
set(LIBZIP_HEADER_NAME zip.h)
set(LIBZIP_DYNAMIC_LIBRARY_NAME libzip.so.5.5)
...
# 添加外部构建项目。
if (NOT (LIBZIP_DYNAMIC_LIBRARY AND LIBZIP_INCLUDE_DIRECTORY))
    include(ExternalProject)
    set(LIBZIP_BUILD_DIRECTORY ${LIBZIP_DIRECTORY}/build)
    set(LIBZIP_SOURCE_DIRECTORY ${LIBZIP_DIRECTORY}/source)
    get_filename_component(OPENSSL_LIBRARY_DIRECTORY ${OPENSSL_DYNAMIC_LIBRARY} DIRECTORY)
    ...
    ExternalProject_Add(
            ...
            PATCH_COMMAND ${CMAKE_COMMAND} -DLIBZIP_SOURCE_DIR=${LIBZIP_SOURCE_DIRECTORY} -DZLIB_LIBRARY=${ZLIB_DYANMIC_LIBRARY} -P ${CMAKE_SOURCE_DIR}/cmakes/linux/libzip/zlib_patch.cmake
            CONFIGURE_COMMAND ${CMAKE_COMMAND} --fresh -S ${LIBZIP_SOURCE_DIRECTORY} -B ${LIBZIP_BUILD_DIRECTORY}
                ...
                -DOPENSSL_CRYPTO_LIBRARY=${CRYPTO_DYNAMIC_LIBRARY}
                -DOPENSSL_INCLUDE_DIR=${OPENSSL_INCLUDE_DIRECTORY}
                -DBUILD_SHARED_LIBS:BOOL=ON
                -DZLIB_LIBRARY=${ZLIB_DYNAMIC_LIBRARY}
                -DZLIB_INCLUDE_DIR=${ZLIB_INCLUDE_DIRECTORY}
                -DBZIP2_LIBRARY_DEBUG=${BZIP2_DYNAMIC_LIBRARY}
                -DBZIP2_LIBRARY_RELEASE=${BZIP2_DYNAMIC_LIBRARY}
                -DBZIP2_INCLUDE_DIR=${BZIP2_INCLUDE_DIRECTORY}
                -DLIBLZMA_LIBRARY_RELEASE=${XZ_DYNAMIC_LIBRARY}
                -DLIBLZMA_LIBRARY_DEBUG=${XZ_DYNAMIC_LIBRARY}
                -DLIBLZMA_INCLUDE_DIR=${XZ_INCLUDE_DIRECTORY}
                -Dzstd_STATIC_LIBRARY=${ZSTD_DYNAMIC_LIBRARY}
    ...
    set(LIBZIP_DYNAMIC_LIBRARY ${LIBZIP_LIBRARY_DIRECTORY}/${LIBZIP_DYNAMIC_LIBRARY_NAME})
...
list(APPEND LIBRARIES ${LIBZIP_DYNAMIC_LIBRARY})
list(APPEND DYNAMIC_LIBRARIES ${LIBZIP_DYNAMIC_LIBRARY})

unset(LIBZIP_HEADER_NAME)
unset(LIBZIP_DYNAMIC_LIBRARY_NAME)
