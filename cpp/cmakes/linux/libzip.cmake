...
set(LIBZIP_NAME libzip-release-static)
...
if (COMPILE_DYNAMIC_MODE)
    set(LIBZIP_LIBRARY_NAME ${LIBZIP_DYNAMIC_LIBRARY_NAME})
endif ()
...
# 添加外部构建项目。
if (NOT (
    ((NOT COMPILE_DYNAMIC_MODE) AND LIBZIP_LIBRARY AND LIBZIP_INCLUDE_DIRECTORY)
    OR
    (COMPILE_DYNAMIC_MODE AND LIBZIP_DYNAMIC_LIBRARY AND LIBZIP_LIBRARY AND LIBZIP_INCLUDE_DIRECTORY)
))
    ...
    ExternalProject_Add(
            ...
            URL_HASH SHA256=3f78eaac85d98d5ac41cc640834dafba7257eb81989854aeb456ed91a177d7c2
