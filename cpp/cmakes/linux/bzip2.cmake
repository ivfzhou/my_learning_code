...
if (COMPILE_DYNAMIC_MODE)
    set(BZIP2_LIBRARY_NAME ${BZIP2_DYNAMIC_LIBRARY_NAME})
endif ()
...
# 添加外部构建项目。
if (NOT (
    (COMPILE_DYNAMIC_MODE AND BZIP2_DYNAMIC_LIBRARY AND BZIP2_LIBRARY AND BZIP2_INCLUDE_DIRECTORY)
    OR
    ((NOT COMPILE_DYNAMIC_MODE) AND BZIP2_LIBRARY AND BZIP2_INCLUDE_DIRECTORY)
))
    ...
    ExternalProject_Add(
            ...
            URL_HASH SHA256=b803cdb2d044a53bde3b89cbbe811486035c885994e75f2879116ca7be0f613b
