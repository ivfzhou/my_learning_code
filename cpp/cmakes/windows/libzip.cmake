...
if(LIBZIP_LIB AND LIBZIP_INCLUDE_DIR)
    ...
    ExternalProject_Add(
        ...
        CONFIGURE_COMMAND cd ${LIBZIP_DEPENDENCIES_PREFIX}/src && rd /s /q libzip-build && md libzip-build
        BUILD_COMMAND cd ${LIBZIP_DEPENDENCIES_PREFIX}/src/libzip-build && ${CMAKE_COMMAND} -DCMAKE_INSTALL_PREFIX=${LIBZIP_DEPENDENCIES_PREFIX} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DBUILD_SHARED_LIBS=OFF -DZLIB_LIBRARY=${ZLIB_LIB} -DZLIB_INCLUDE_DIR=${ZLIB_INCLUDE_DIR} ../libzip
