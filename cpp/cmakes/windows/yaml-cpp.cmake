...
if(YAML_CPP_LIBRARY AND YAML_CPP_INCLUDE_DIRECTORY)
    ...
    ExternalProject_Add(
        ...
        BUILD_COMMAND cd ${YAML_CPP_DIRECTORY}/src/yaml-cpp-build && ${CMAKE_COMMAND} -DCMAKE_INSTALL_PREFIX=${YAML_CPP_DIRECTORY} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DBUILD_SHARED_LIBS=OFF -DYAML_MSVC_SHARED_RT=OFF -DCMAKE_MSVC_RUNTIME_LIBRARY=${CMAKE_MSVC_RUNTIME_LIBRARY} ../yaml-cpp
