...
if(JWT_CPP_INCLUDE_DIR)
    ...
    ExternalProject_Add(
        ...
        CONFIGURE_COMMAND cd ${JWT_CPP_DEPENDENCIES_PREFIX}/src && rd /s /q jwt-cpp-build && md jwt-cpp-build
        BUILD_COMMAND cd ${JWT_CPP_DEPENDENCIES_PREFIX}/src/jwt-cpp-build && ${CMAKE_COMMAND} -DCMAKE_INSTALL_PREFIX=${JWT_CPP_DEPENDENCIES_PREFIX} -DBUILD_SHARED_LIBS=OFF -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DOPENSSL_ROOT_DIR=${OPENSSL_DEPENDENCIES_PREFIX} -DJWT_BUILD_EXAMPLES=OFF ../jwt-cpp
