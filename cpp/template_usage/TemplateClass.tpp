...
namespace gitee::com::ivfzhou::cpp {
    ...
    template<typename T, typename E>
    std::ostream& operator<<(std::ostream& os, TemplateClass<T, E>&) {
        return os;
    }
    ...
    template<typename T, typename E>
    TemplateClass<T, E>::TemplateClass(const TemplateClass& c) :
        constField(c.publicField), constReferenceField(c.publicField) {
